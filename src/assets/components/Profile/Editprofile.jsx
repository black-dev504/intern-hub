...
const Editprofile = () => {
  ...
  return (
    <section className='bg-white px-5 profile-font lg:px-30 py-15'>
        <div className='flex flex-col items-center'>
            ...
            <div className='mt-10 flex flex-col  justify-center w-full'>
                <div className='profile-header  justify-start flex flex-col '>
                    <h1 className='text-black text-left font-bold text-2xl md:text-3xl'>Profile header</h1>
                    <div className='grid lg:grid-cols-2 gap-3 mt-3 '>

                    <div>
                        <label htmlFor="" className='block font-medium text-xl md:text-2xl mb-4'>Name</label>
                        <input type="text" name="username" id="" placeholder='Name' className='w-full rounded-xl border-1 border-[#939393] py-4 px-6' />
                    </div>

                    <div>
                        <label htmlFor="" className='block font-medium text-xl md:text-2xl mb-4'>Email Address</label>
                    ...
                    <div>
                        <label htmlFor="" className='block font-medium text-xl md:text-2xl mb-4'>Professional Title</label>
                    ...
                    <div>
                        <label htmlFor="" className='block font-medium text-xl md:text-2xll mb-4'>Phone Number</label>
                ...
                <div className='prof-summary flex flex-col mt-3 '>
                    <h1 className='text-black text-left font-bold text-2xl md:text-3xl'>Professional Summary</h1>
                    <p className='mt-4 mb-4 text-xl md:text-2xl font-medium'>About me</p>
                    ...
                    <div>
                        <p className=' font-medium text-xl md:text-2xl mt-3'>Skills</p>
                ...
                <h1 className='text-black text-left font-bold text-2xl md:text-3xl'>Academic Information</h1>
                <div className='grid lg:grid-cols-2 gap-3 mt-3 '>

                    <div>
                        <label htmlFor="" className='block font-medium text-xl md:text-2xl mb-4'>Current Institution</label>
                    ...
                    <div>
                        <label htmlFor="" className='block font-medium text-xl md:text-2xl mb-4'>Course of Study</label>
                        <input type="text" name="email" id="" placeholder='Computer Science' className='w-full rounded-xl border-1 border-[#939393] py-4 px-6' />
                    </div>

                    <div> 
                        <label htmlFor="" className='block font-medium text-xl md:text-2xl mb-4'>Year of Study</label>
                        <input type="text" name="title" id="" placeholder='3rd year' className='w-full rounded-xl border-1 border-[#939393] py-4 px-6' />
                    </div>

                    <div>
                        <label htmlFor="" className='block font-medium text-xl md:text-2xl mb-4'>Internship Type</label>
                        <select
                                name="internshipType"
                                id="internshipType"
