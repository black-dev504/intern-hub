...
const Ready = () => {
  return (
    <div className="my-18 bg-[url('/images/readypic.png')] bg-cover bg-center text-center items-center justify-center font-bold text-4xl px-5 md:px-20 py-15 flex flex-col">
